const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      minPrice: 'Min Price',
      maxPrice: 'Max Price',
      priceDropTarget: 'Price Drop Alert Target',
      priceDropTargetPlaceholder: 'Leave blank to disable price-drop monitoring',
      priceDropTargetHint: 'Sends a price-drop notification once a recommended item\'s price falls to or below this value; leave blank to disable.',
    ...
    table: {
      ...
      priceDropTarget: 'Alert at ¥{price}',
  ...
  notifyPanel: {
    ...
    linkTypes: {
      title: 'Notification link types',
      mobile: 'Mobile link',
      desktop: 'Desktop link',
      atLeastOneRequired: 'At least one link type must be selected',
    },
