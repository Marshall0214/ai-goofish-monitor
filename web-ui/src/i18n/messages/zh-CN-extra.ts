const zhCNExtra = {
  tasks: {
    ...
    form: {
      ...
      minPrice: '最低价',
      maxPrice: '最高价',
      priceDropTarget: '降价提醒目标价',
      priceDropTargetPlaceholder: '留空表示不监控降价',
      priceDropTargetHint: '已推荐的商品价格跌到该价格或以下时会发送降价通知；留空则不监控降价。',
      maxPages: '搜索页数',
      schedule: '定时规则',
      cronPresetTab: '预设',
      cronCustomTab: '自定义',
  ...
  notifyPanel: {
    ...
    linkTypes: {
      ...
      mobile: '手机端链接',
      desktop: '电脑端链接',
      atLeastOneRequired: '至少需要选择一种链接类型',
    },
